...
// ============================================================
// C7 – CORRECTED ROOM NUMBERS
// ============================================================
// Ground floor: 1-4 (4 beds each), room 7 (1 bed), 8-10 (4 beds each)
$configs[] = ['C7', 0, range(1,4), 4, []];
$configs[] = ['C7', 0, [7,8,9,10], 4, [7 => 1]];

// 1st floor: rooms 101-105 and 107-111 (all 4 beds each)
$configs[] = ['C7', 1, array_merge(range(101,105), range(107,111)), 4, []];

// 2nd floor: rooms 201-205 and 206-210 (all 4 beds each)
$configs[] = ['C7', 2, array_merge(range(201,205), range(206,210)), 4, []];

// ============================================================
// C8 – CORRECTED (removed room 100 on 3rd floor)
// ============================================================
$configs[] = ['C8', 0, range(1,16), 4, []];
$configs[] = ['C8', 1, range(17,44), 4, []];
$configs[] = ['C8', 2, range(45,72), 4, []];
$configs[] = ['C8', 3, range(73,99), 4, []]; // room 100 removed
